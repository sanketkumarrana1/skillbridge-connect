...
export const INITIAL_MENTORSHIP_REQUESTS: MentorshipRequest[] = [
  {
    ...
    mentorId: "mentor-ind-01",
    mentorName: "Priyanshu Dave",
    mentorType: "industry",
    mentorOrganization: "Razorpay",
    requestedAt: "24 Aug 2026",
    purpose: "Review of Full-Stack UPI checkout system project and mock architectural interview.",
    preferredDate: "01 Sep 2026",
    preferredTime: "10:00 AM - 10:45 AM",
    status: "Accepted",
    notes: "Please have your GitHub repository and live demo link ready.",
  },
  {
    id: "req-ment-02",
    studentId: "stud-sanket-01",
    studentName: "Sanket Kumar Rana",
    mentorId: "mentor-fac-01",
    mentorName: "Dr. Rajesh Kulkarni",
    mentorType: "faculty",
    mentorOrganization: "NITK",
    requestedAt: "26 Aug 2026",
    purpose: "Guidance on publication strategy for distributed cache consistency paper.",
    preferredDate: "07 Sep 2026",
...
export const INITIAL_MENTORSHIP_SESSIONS: MentorshipSession[] = [
  {
    ...
    endTime: "10:45 AM",
    mode: "Online",
    meetingLink: "https://meet.google.com/acd-razorpay-ment",
    status: "Scheduled",
    purpose: "Review of Full-Stack UPI checkout system project and mock architectural interview.",
    mentorPrivateNotes: "Strong candidate from NITK with deep React & TypeScript mastery.",
  },
  {
    id: "sess-ment-02",
    requestId: "req-ment-prev-01",
    studentId: "stud-sanket-01",
    studentName: "Sanket Kumar Rana",
    mentorId: "mentor-ind-02",
    mentorName: "Tanvi Joshi",
    mentorType: "industry",
    mentorOrganization: "Swiggy",
    date: "15 Aug 2026",
    startTime: "03:00 PM",
    endTime: "03:45 PM",
    mode: "Online",
    meetingLink: "https://meet.google.com/acd-swiggy-ai",
    status: "Completed",
    purpose: "Evaluation of Recommendation Engine pipeline and PyTorch embeddings.",
    mentorPrivateNotes: "Excellent grasp of cosine similarity vectors and latency optimizations.",
    outcome: {
      topicsDiscussed: [
        "Vector database indexing with FAISS and Pinecone",
        "Cold-start item recommendation heuristics",
        "Model deployment on AWS ECS with Triton Inference Server",
      ],
      followUpRecommendations: [
        "Benchmark inference throughput with TensorRT",
        "Add Grafana telemetry for p99 query latencies",
      ],
      summary:
        "Sanket demonstrated outstanding initiative in building the recommendation service. Highly recommended for Senior Intern / APM tracks.",
    ...
    studentFeedback: {
      ...
      comment:
        "Tanvi provided actionable advice on latency profiling that helped me optimize query times from 120ms to 18ms. Outstanding session!",
...
export const INITIAL_PLACEMENT_HISTORY: PlacementHistoryItem[] = [
  {
    ...
    compensation: "₹45,000 / mo + PPO Track",
    relevantSkills: ["React", "TypeScript", "Tailwind CSS", "REST APIs", "State Management"],
    verifiedAt: "25 Aug 2026",
